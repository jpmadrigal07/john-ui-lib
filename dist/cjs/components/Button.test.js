...
describe('Button', function () {
    ...
    test("Renders correctly", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Button_1.Button, tslib_1.__assign({ variant: "primary" }, { children: "Primary" })));
        var textElement = react_1.screen.getByText("Primary");
        expect(textElement).toBeInTheDocument();
    });
    test("Primary as a default is rendered", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Button_1.Button, { children: "Primary" }));
        var textElement = react_1.screen.getByText("Primary");
        expect(textElement).toHaveClass("bg-blue-500");
    });
    test("Secondary is rendered", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Button_1.Button, tslib_1.__assign({ variant: "secondary" }, { children: "Secondary" })));
    ...
    test("Medium size as a default is rendered", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Button_1.Button, tslib_1.__assign({ variant: "primary" }, { children: "Medium" })));
    ...
    test("Large size is rendered", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Button_1.Button, tslib_1.__assign({ variant: "primary", dim: "lg" }, { children: "Large" })));
        var textElement = react_1.screen.getByText("Large");
        expect(textElement).toHaveClass("text-lg py-3 px-4");
    });
    test("Is clicked", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Button_1.Button, tslib_1.__assign({ variant: "primary", dim: "lg", onClick: onClickButton }, { children: "Click" })));
        var textElement = react_1.screen.getByText("Click");
        react_1.fireEvent.click(textElement);
        expect(onClickButton).toHaveBeenCalled();
    });
    test("Is disabled", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Button_1.Button, tslib_1.__assign({ variant: "primary", dim: "lg", disabled: true }, { children: "Disabled" })));
