...
describe('Input', function () {
    test("Renders correctly", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Input_1.Input, { type: "text", "data-testid": "render" }));
        var element = react_1.screen.getByTestId("render");
        expect(element).toBeInTheDocument();
    });
    test("Is disabled", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Input_1.Input, { type: "text", "data-testid": "disabled", disabled: true }));
    ...
    test("Is focused", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Input_1.Input, { type: "text", "data-testid": "focus" }));
    ...
    test("Allow any character if type text", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Input_1.Input, { type: "text", "data-testid": "text" }));
    ...
    test("Allow number if type number", function () {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(Input_1.Input, { type: "number", "data-testid": "number" }));
